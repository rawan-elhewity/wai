              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="mailto:info@wai-soft.com" className="text-navy/70 dark:text-silver hover:text-primary transition-colors">
                      info@wai-soft.com
                    </a>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="flex gap-3">
                      <a href="https://www.instagram.com/wai.soft" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center text-navy/70 dark:text-silver hover:text-primary hover:bg-primary/20 transition-colors">
