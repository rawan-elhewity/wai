    ...
    return (
      <div className="min-h-screen pt-24 flex items-center justify-center px-4">
        ...
        >
          ...
          <p className="text-navy/70 dark:text-silver mb-8">{t.contact.successText}</p>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="mailto:info@wai-soft.com" className="text-navy/70 dark:text-silver hover:text-primary transition-colors block">
                      info@wai-soft.com
                    </a>
                    <a href="mailto:support@wai-soft.com" className="text-navy/70 dark:text-silver hover:text-primary transition-colors block">
                      support@wai-soft.com
                    </a>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-navy dark:text-white">{locale === "ar" ? "الهاتف" : "Phone"}</h3>
                    <a href="tel:+201070537446" className="text-navy/70 dark:text-silver hover:text-primary transition-colors block" dir="ltr">
                      +20 107 053 7446
                    </a>
                    <a href="tel:+201070537447" className="text-navy/70 dark:text-silver hover:text-primary transition-colors block" dir="ltr">
                      +20 107 053 7447
                    </a>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <a href="https://wai-soft.com" target="_blank" rel="noopener noreferrer" className="text-navy/70 dark:text-silver hover:text-primary transition-colors">
                      wai-soft.com
                    </a>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <h3 className="font-semibold text-navy dark:text-white mb-2">{locale === "ar" ? "تابعنا" : "Follow Us"}</h3>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-navy/70 dark:text-silver">{t.contact.address}</p>
                  </div>
                </motion.div>
              </div>
